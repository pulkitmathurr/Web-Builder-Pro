          ...
          <div className="infra-hero-inner" style={{ position: 'relative', zIndex: 1, display: 'flex', flexDirection: 'column', gap: '18px' }}>
            ...
            <div className="infra-hero-item infra-hero-actions" style={{ display: "flex", justifyContent: 'flex-end', gap: "8px" }}>
                <button
                  ...
                  style={{
                    padding: "7px 14px",
                    background: isDirty ? "rgba(250,204,21,0.15)" : "rgba(255,255,255,0.08)",
                    color: isDirty ? "#fde047" : "rgba(255,255,255,0.65)",
                    border: isDirty ? "1px solid rgba(250,204,21,0.35)" : "1px solid rgba(255,255,255,0.15)",
                    borderRadius: "6px",
                    fontSize: "12px",
                ...
                {isPublished ? (
                  ...
                  <button
                    ...
                    style={{
                      ...
                      fontWeight: 700,
                      cursor: "pointer",
                      boxShadow: `0 2px 10px ${hexToRgba(tc.primary, 0.35)}`,
                    }}
                  >
